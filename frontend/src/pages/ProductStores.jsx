...
const ProductStores = () => {
  ...
  // // ✅ UPDATED: Handle Cash Payment with API call
  // const handlePlaceOrder = async () => {
  //   if (paymentMethod === "cash") {
  //     // Prepare order data for cash payment
  //     const orderData = {
  //       customerId: user?.id || 1, // ✅ Get from logged-in user or default
  ...
  //     }
  //   } else {
  //     // Show card payment modal for card payment
...
//     if (paymentMethod === "cash") {
//       setShowOrderModal(false);
//       alert(`Order placed successfully! Your order will be delivered in ${selectedStore.deliveryTime}.`);
//     } else {
//       setShowPaymentModal(true);
//     }
//   };
...
//       cardholderName: "",
//     });
//     alert(`Payment successful! Your order will be delivered in ${selectedStore.deliveryTime}.`);
//   };
