...
const Footer = () => {
  return (
    <div className='md:mx-10 mt-10 rounded-2xl'>
      <div className='flex flex-col sm:grid grid-cols-[2fr_1fr_1fr_1fr] gap-10 my-10 mt-10 text-sm'>
        ...
        <div>
          ...
          <p className='w-full md:w-2/3 text-gray-700 leading-6'>Your trusted partner in healthcare delivery.<br/> Providing genuine medicines with fast,<br/> reliable service since 2020.</p>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-2 text-gray-800 '>
            ...
            <NavLink to={'/about'}>
                <li className='hover:thover:text-pButtonH cursor-pointer'>About us</li>
            </NavLink>
            
                <li className='hover:hover:text-pButtonH cursor-pointer'>Pharmacies</li>
        ...
        <div>
          ...
          <div className='flex flex-col gap-3'>
            <p className='flex flex-cols gap-2 text-gray-800 hover:hover:text-pButtonH cursor-pointer'><Mail/> pillpath@gmail.com</p>
            <p className='flex flex-cols gap-2 text-gray-800 hover:hover:text-pButtonH cursor-pointer'><Phone/> +9411321489</p>
          </div>
      ...
      <div>
            <hr/>
            <p className='py-3 text-sm text-center'>Copyright © 2025 PillPath - All Right Reserved.</p>
        </div>
