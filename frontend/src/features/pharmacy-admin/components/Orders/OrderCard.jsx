...
import { Calendar, CreditCard, DollarSign, Package, Eye, Printer, User } from 'lucide-react';
      ...
      case 'mixed':
        return (
          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
            <span className="mr-1">📦</span> Mixed Order
          </span>
        );
      default:
        return (
      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-base text-gray-900 font-medium">{order.customer.name}</p>
        ...
        <div className="grid grid-cols-5 gap-10 mb-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">{formatTime(order.orderDate)}</p>
          </div>

          <div>
            <Link
              to={`/pharmacy/pharmacyorders/${order.id}`}
