...
const Sidebar = () => {
  ...
  // Determine active item based on current route (allow override from navigation state)
  const getActiveItem = () => {
    const override = location.state && location.state.activeOverride;
            ...
            if (item.path === "#") {
              return (
                ...
                >
                  ...
                  <span className="ml-auto text-xs bg-gray-600 px-2 py-0.5 rounded">
                    Soon
                  </span>
                </button>
              );
