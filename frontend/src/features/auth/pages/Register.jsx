  ...
  const getSuccessMessage = () => {
    if (selectedRole === "customer") {
      return {
        ...
        message:
          "Your account has been created successfully. You can now start exploring our services.",
      ...
      return {
        ...
        message:
          "Your pharmacy registration has been submitted for review. We'll notify you once it's approved.",
        action: "Back to Home",
      };
    }
  };
    ...
    return (
      <div className="min-h-screen bg-dark-theme flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-white/70 mb-8">{successInfo.message}</p>
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
          <div className="w-full max-w-6xl">
            ...
            <div className="text-center mb-8">
              <Link
                to="/"
                className="inline-flex items-center gap-2 text-white/70 hover:text-white transition-colors duration-300 mb-6"
              >
                <ArrowLeft size={20} />
                Back to Home
              </Link>
            ...
            >
              {currentStep === "role" ? (
                ...
                <RegisterForm
                  ...
                  showGoogle={selectedRole === "customer"}
                />
              )}
            </motion.div>
